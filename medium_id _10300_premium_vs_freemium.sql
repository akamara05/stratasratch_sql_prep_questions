WITH download_totals AS (
    ...
    -- Based on a preview of the ms_download_facts table it makes more sense to use SUM instead of COUNT
    -- as each cutsomer may have muultiple downloads per days. 
...
-- ASC not necessary to include it's assumed as the default.
